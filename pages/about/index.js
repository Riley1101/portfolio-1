  ...
  return (
    ...
    <Navbar/>
     ...
     <div className='pb-10 pt-24 2xl:pt-32 2xl:h-[88vh]'>
         ...
         <div className=' grid lg:grid-cols-[40%,60%] 2xl:grid-cols-2 2xl:gap-6 gap-3 mt-5'>
            <div className=' w-full h-[260px] 2xl:h-[300px] relative'>
                <Image alt='my image' src={'/me.JPG'} className=' -z-10 absolute rounded-xl object-cover object-[0%,30%]'  layout='fill'/>
            </div>
